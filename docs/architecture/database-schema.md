...
**As of:** v0.3 (Alembic revision `0001_initial_helvetia_schema`)

Current PostgreSQL schema for the Helvetia structured domain. Field-level definitions live in [data-model.md](data-model.md).
...
| Seed entrypoint | `scripts/seed_db.py` |

Apply schema: `alembic upgrade head`  
Reseed data: `python scripts/seed_db.py`
