...
These three use cases define the **minimum** structured data required for Helvetia Private Bank. Schema fields exist because these workflows need them. Email draft, approval, and send are out of scope.
...
The employee asks why a client transfer is delayed (via inspection of structured APIs).
